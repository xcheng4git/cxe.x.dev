...
namespace vo
{
	...
	class DENSEVO_API RgbdCamera
	{
	public:
		RgbdCamera(size_t width, size_t height, const vo::IntrinsicMatrix& intrinsics);
		~RgbdCamera();
		...
		const vo::IntrinsicMatrix& intrinsics() const;
	...
	private:
		...
		vo::IntrinsicMatrix intrinsics_;
	...
	class DENSEVO_API RgbdCameraPyramid
	{
	public:
		RgbdCameraPyramid(const RgbdCamera& base);
		RgbdCameraPyramid(size_t base_width, size_t base_height, const vo::IntrinsicMatrix& base_intrinsics);
	...
	public:
		...
		typedef vo::PointCloud PointCloud;
	...
	class DENSEVO_API RgbdImagePyramid
	{
	public:
		typedef boost::shared_ptr<vo::RgbdImagePyramid> Ptr;
